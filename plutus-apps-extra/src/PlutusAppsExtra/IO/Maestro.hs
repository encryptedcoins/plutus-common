...
-- -- newtpe to run maestro functions in IO
-- newtype WithMaestroTokenAndNetworkId a = WithMaestroTokenAndNetworkId {unWIthMaestroTokenAndNetworkId :: ReaderT (NetworkId, MaestroToken) IO a}
--     deriving newtype (Functor, Applicative, Monad, MonadIO)

-- withMaestroTokenAndNetworkId :: NetworkId -> MaestroToken -> WithMaestroTokenAndNetworkId a -> IO a
-- withMaestroTokenAndNetworkId network token ma = flip runReaderT (network, token) $ unWIthMaestroTokenAndNetworkId ma